...
if( d(h, ".adpro.cn") ){  return BLACK_HOLE; }
// {All Domain File Rule Filtration U+ Proxy}
...
// {All Domain Path Rule Filtration U+ Proxy}
...
/////////////////////////////////////////////////
// {Down Site Domain Rule Filtration U+ Proxy} //
// {Last Modified Time:2016-2-10 04:14   Eval} //
/////////////////////////////////////////////////
// {http://www.jb51.net}
...
/////////////////////////////////////////////////
// {News Site Domain Rule Filtration U+ Proxy} //
// {Last Modified Time:2016-2-10 04:14   Eval} //
/////////////////////////////////////////////////
// {http://www.ifeng.com}
...
/////////////////////////////////////////////////
// {Tools Site Domain Rule Filtration U+ Proxy}//
// {Last Modified Time:2016-2-5 01:46:10 Eval} //
/////////////////////////////////////////////////
// {http://www.chinaz.com}
...
/////////////////////////////////////////////////
// {Viedo Site Domain Rule Filtration U+ Proxy}//
// {Last Modified Time:2016-2-17 06:40   Eval} //
/////////////////////////////////////////////////
// {http://www.youku.com}
...
// {http://www.iqiyi.com}
if( ( d(h, "static.iqiyi.com") && s(u, "*qa.js*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "static.iqiyi.com") && s(u, "*iwt.js*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "api.cupid.iqiyi.com") && s(u, "*track2*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "api.cupid.iqiyi.com") && s(u, "*show2*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "static.qiyi.com") && s(u, "*skinad.css*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
//¡ýADSAFE TEST 
if( ( d(h, "msg.71.am") && s(u, "*cp2.gif*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "t7z.cupid.iqiyi.com") && s(u, "*track2*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "ckm.iqiyi.com") && s(u, "*pixel*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "irs01.com") && s(u, "*crossdomain.xml") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "mixer.video.iqiyi.com") && s(u, "*recommend*videos*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "msg.71.am") && s(u, "*vpb.gif*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "a.ads.cn.miaozhen.com") && s(u, "*crossdomain.xml*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "www.iqiyi.com") && s(u, "*icon.swf*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "static.iqiyi.com") && s(u, "*tipdata*.xml*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "b.scorecardresearch.com") && s(u, "*b*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "www.iqiyi.com") && s(u, "*skipgg_zz.swf*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "t7z.cupid.iqiyi.com") && s(u, "*crossdomain.xml*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "static.iqiyi.com") && s(u, "*ares.min.js*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "s.cr-nielsen.com") && s(u, "*hat*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "uestat.video.qiyi.com") && s(u, "*stat.html*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "msg.71.am") && s(u, "*b*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "msg.71.am") && s(u, "*tmpstats.gif*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "static.iqiyi.com") && s(u, "*headerqa*.js*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "p.tanx.com") && s(u, "*ex*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "x.jd.com") && s(u, "*exsites*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "hm.baidu.com") && s(u, "*hm.js*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "static.iqiyi.com") && s(u, "*js*pingback*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "cache.video.qiyi.com") && s(u, "*vms*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "www.iqiyi.com") && s(u, "*icon.swf*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
if( ( d(h, "msg.video.qiyi.com") && s(u, "*vodpb.gif*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
// {http://v.qq.com}
...
/////////////////////////////////////////////////
// {Music Site Domain Rule Filtration U+ Proxy}//
// {Last Modified Time:2016Äê2ÔÂ10ÈÕ04:22 Eval}//
/////////////////////////////////////////////////
// {http://play.baidu.com}
...
if( ( d(h, "static.pay.baidu.com") && s(u, "*/adpadmin_feed/*") ) || d(h, "Domain.in") ){ return BLACK_HOLE;}
/////////////////////////////////////////////////
// {IOS Mobile Domain Rule Filtration U+ Proxy}//
// {Last Modified Time:2016-2-23 12:46:43 Eval}//
/////////////////////////////////////////////////
